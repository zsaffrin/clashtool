<div class="size-1-1">
	...
	<div class="size-1-2 grid-stick">
		<?php $this->displayForm($this->new_user_form); ?>
	</div>
						...
						<tr>
							...
							<td>
								<ul class="inline-user-tools">
									<li>
										<a 
										  href="<?php echo 'forcePasswordReset/'.$u->user_id; ?>" 
										  title="Force Password Reset" 
										  <?php if ($u->force_password_reset == 1) { echo ' class="active"'; } ?> >
									...
									<li>
										<?php
											if ($u->user_status == 0) {
												echo '<a href="activateUser/'.$u->user_id.'" title="Approve user" class="active">';
												...
												echo '<a href="toggleUserLock/'.$u->user_id.'" title="Unlock user" class="active">';
